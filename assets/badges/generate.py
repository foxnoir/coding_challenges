...
official color is black, pick from the palette (purple / blue / turquoise /
pink / green). Avoid black, orange, red, and yellow.
"""
...
BADGES: list[tuple[str, str, str, str]] = [
    ...
    ("bloc", "Bloc", "#5E6AA8", "blue-violet (replaces dark red)"),
    ("flutter_bloc", "Flutter Bloc", "#2E86C1", "blue"),
    ("dartz", "Dartz", "#1C4E80", "blue"),
    ("equatable", "Equatable", "#4A8C6F", "green"),
    ("get_it", "GetIt", "#2A9D8F", "turquoise"),
    ("mocktail", "Mocktail", "#8B5FBF", "app purple"),
